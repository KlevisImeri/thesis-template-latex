...
Now lets run the algorithm on this example.
Well now we can choose the order we can vites the nodes, it can be BFS or DFS order.
In this case here I will chose BFS to have a more simple explanation.
...
switches
function return and fucntion enter
